...
return (
  <ThumbMaster current={currentMaster} pressed={thumbState} onClick={() => handleThumbClick()}>
    <ThumbSVG width={'50'} height={'50'} fill={thumbState ? 'red' : 'black'} />
  </ThumbMaster>
)
}
